...
<body>
  ...
  <!-- ########## START: LEFT PANEL ########## -->
  <div class="br-logo tx-16"><a href=""><span>[</span>M Kamrul Tours & Travels<span>]</span></a></div>
  <div class="br-sideleft overflow-y-auto">
    ...
    <div class="br-sideleft-menu">
      ...
      <a href="#" class="br-menu-link @yield('income')">
        <div class="br-menu-item">
            <i class="fa fa-usd tx-24" aria-hidden="true"></i>
          <span class="menu-item-label">Incomes</span>
      ...
      <a href="#" class="br-menu-link @yield('expense')">
        <div class="br-menu-item">
            <i class="fa fa-minus-square tx-22" aria-hidden="true"></i>
          <span class="menu-item-label">Expeses</span>
          <i class="menu-item-arrow fa fa-angle-down"></i>
        </div>
      </a>
      <ul class="br-menu-sub nav flex-column">
        <li class="nav-item"><a href="{{ route('allExpenseList') }}" class="nav-link @yield('all_ex_active')">All Expenses List</a></li>
        <li class="nav-item"><a href="{{ route('addExpenseList') }}" class="nav-link @yield('add_ex_active')">Add Monthly Expenses</a></li>
      </ul>
